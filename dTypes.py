...
# # # modify cheyyalemu  we cant modify primitive dataTypes cause single-value dTypes
# # # dict:
...
# # asd=[1.1,1.2] 
# # abc=[[1,2,3],"vamsi"]
# # xyz=[{"id":1},{"id":2}] # real time data


# # list of dicts 
# # define = creating

# # defining =     assigning (dTypes,function,class)
# # employees=[{
# #     "id":1,
# #     "name":"vamsi",
# #     "loc":"hyd",
